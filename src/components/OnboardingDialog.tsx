...
const OnboardingDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="w-[90vw] max-w-sm mx-auto sm:w-full sm:max-w-md">
        <DialogHeader className="space-y-3">
          <div className="mx-auto w-14 h-14 sm:w-16 sm:h-16 flex items-center justify-center flex-shrink-0">
            <img src="/icon-option-6-blue.png" alt="App Icon" className="w-full h-full rounded-2xl" />
          </div>
          <DialogTitle className="text-center text-base sm:text-lg leading-snug break-words hyphens-auto px-1">You are almost to the most effortless and rewarding calendar management you have ever experienced! You will never miss your important dates.</DialogTitle>
        </DialogHeader>

        <div className="text-center font-semibold text-xs sm:text-sm text-foreground pt-2 pb-1 px-2 break-words">
          Free Plan Includes feeds from up to two schools or organizations.
        </div>

        <div className="space-y-2 sm:space-y-3 pb-3 sm:pb-4 overflow-y-auto max-h-[50vh]">
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          <Button 
            ...
            className="w-full text-xs sm:text-sm leading-tight py-3 sm:py-2 h-auto"
